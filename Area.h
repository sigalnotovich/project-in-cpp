...
namespace mtm {
	...
	*/
	...
	protected:
		...
		//the places to which we can go from this area
		MtmSet<std::string> reachable_areas_set;
		/*std::string getName();
		std::vector<GroupPointer>& getGroupsInArea();
		MtmSet<std::string>& getReachableAreasSet();*/
	...
	public:
		...
		*  same name;
		*/
		virtual void groupLeave(const std::string& group_name); //=0;
