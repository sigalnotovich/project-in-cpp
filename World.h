...
namespace mtm {
	...
	class World {
		...
		//areas:
		//MtmSet<AreaPtr> areas_set;
		map<string, AreaPtr> areas_map;
		MtmSet<std::string> clans_names;
		MtmSet<std::string> areas_names;
		//MtmSet<std::string> groups_names;
		map <string, string> groups_clans_names; //map <group,clan>
